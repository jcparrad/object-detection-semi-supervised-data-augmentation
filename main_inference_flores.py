...
#sys.path.append("..")
#sys.path.append("/home/obj_api_2/models/research/object_detection")
...
# This is needed to display the images in jupyter.
# %matplotlib inline
...
#PATH_TO_FROZEN_GRAPH = "/home/detection/flores/models/exported/model_ssd_mobilenet_v1_fpn_2/frozen_model/frozen_inference_graph.pb"
...
# Detection
PATH_TO_TEST_IMAGES_DIR = 'test_images/DJI_3468'
TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, 'frame_{}.jpg'.format(i)) for i in range(219, 1424) ] #

#PATH_TO_TEST_IMAGES_DIR = 'test_images/DJI_0546'
#TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, 'frame_{}.jpg'.format(i)) for i in range(1341, 1481) ]
